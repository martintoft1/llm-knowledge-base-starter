...
## Optional Body Templates

New notes use no body template. Defined pages may start from the matching file under `templates/page-bodies/`:
...
Every heading is optional. Add, rename, or remove headings to fit the page.
